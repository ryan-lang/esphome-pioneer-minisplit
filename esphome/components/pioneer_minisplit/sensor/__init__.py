...
CONFIG_SCHEMA = (
    cv.Schema({
        ...
        cv.Optional(CONF_UNKNOWN_1): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_BRIGHTNESS_5, state_class="measurement").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_FAN_SPEED_ACTUAL): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_TEMP_PIPE_OUT): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement", unit_of_measurement="°C").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_TEMP_PIPE_IN): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement", unit_of_measurement="°C").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_UNKNOWN_2): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_UNKNOWN_3): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_COMPRESSOR_CURRENT): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement", device_class="current", unit_of_measurement="A", accuracy_decimals=1).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_MOTOR): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement").extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_SWING_V_POS): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_SWING_H_POS): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_FAULT): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_CLEAN_FILTER): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_HEALTH): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE).extend(cv.COMPONENT_SCHEMA),
        cv.Optional(CONF_SUPPLY_VOLTAGE): sensor.sensor_schema(PioneerMinisplitSensor, icon=ICON_VIBRATE, state_class="measurement", device_class="voltage", unit_of_measurement="V").extend(cv.COMPONENT_SCHEMA),
    })
)
